...
vim.keymap.set('n', '<leader>bp', ':bp<CR>', { silent = true, desc = 'Go To The Prev Buffer' })
-- go to the next buffer
vim.keymap.set('n', '<leader>bn', ':bn<CR>', { silent = true, desc = 'Go To The Prev Buffer' })
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          -- also add abbilty to use <CTRL-J> <CTRL-K>
          -- Select the [n]ext item
...
vim.api.nvim_create_autocmd('ColorScheme', {
  pattern = '*',
  callback = function()
    vim.cmd 'highlight NeoTreeNormal guibg=#ffffff'
    vim.cmd 'highlight NeoTreeNormalNC guibg=#ffffff'
    vim.cmd 'highlight NeoTreeEndOfBuffer guibg=#ffffff'
    vim.cmd 'highlight NeoTreeWinSeparator guibg=#1e1e2e guifg=#44475a'
  end,
})
